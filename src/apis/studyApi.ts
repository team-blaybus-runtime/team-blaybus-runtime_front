...
const MOCK_DATA: Record<string, StudyObjectDetail> = {
  ...
  "robot-arm": {
    ...
    components: [
      { componentId: "ra-1", componentName: "Base", glbUrl: "/3D Asset/Robot Arm/base.glb" },
      { componentId: "ra-2", componentName: "Part2", glbUrl: "/3D Asset/Robot Arm/Part2.glb" },
      { componentId: "ra-3", componentName: "Part3", glbUrl: "/3D Asset/Robot Arm/Part3.glb" },
      { componentId: "ra-4", componentName: "Part4", glbUrl: "/3D Asset/Robot Arm/Part4.glb" },
      { componentId: "ra-5", componentName: "Part5", glbUrl: "/3D Asset/Robot Arm/Part5.glb" },
      { componentId: "ra-6", componentName: "Part6", glbUrl: "/3D Asset/Robot Arm/Part6.glb" },
      { componentId: "ra-7", componentName: "Part7", glbUrl: "/3D Asset/Robot Arm/Part7.glb" },
      { componentId: "ra-8", componentName: "Part8", glbUrl: "/3D Asset/Robot Arm/Part8.glb" },
    ],
  },
  "robot-gripper": {
    object: {
